                        ...
                        <div className="mt-4 flex gap-4">
                            <HoverCard>
                                <HoverCardTrigger>
                                    <BadgeCheck
                                        size={36}
                                        className="rounded-full border-1 border-blue-700/30 bg-blue-500/20 p-2"
                                    />
                                </HoverCardTrigger>
                                <HoverCardContent>
                            ...
                            <HoverCard>
                                <HoverCardTrigger>
                                    <Shield
                                        size={36}
                                        className="rounded-full border-1 border-green-800/50 bg-emerald-500/20 p-2"
                                    />
                                </HoverCardTrigger>
                                <HoverCardContent>
                    ...
                    <div className="bg-primary-foreground rounded-lg p-4">
                        ...
                        <div className="mt-4 space-y-2">
                            ...
                            <div className="flex items-center gap-2">
                                <span className="text-muted-foreground font-medium italic">Username:</span>
                                <span>khadon</span>
                            </div>
                            <div className="flex items-center gap-2">
                            ...
                            <div className="flex items-center gap-2">
                                <span className="text-muted-foreground font-medium italic">Location:</span>
